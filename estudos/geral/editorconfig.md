# Arquivo .editorconfig
    ...
    o arquivo ".editorconfig" salva as configurações que identação e estilização do seu trabalho.
    Algumas IDEs identificam de maneira automatica outro precisa de uma extenção como o VS Code
